            ...
            <div class="field" style="margin-top:8px;">
                <span class="field__label">
                    ...
                    <span style="margin-left:6px; font-size:11px; font-weight:400; color:var(--color-text-muted);">
                        (<?= count($categories_flat) ?> depuis le cache local)
                    </span>
                </span>
                <span class="field__hint" style="margin-bottom:8px;">
                    ...
                    <?php if (empty($categories_flat)): ?>
                        <br><span style="color:var(--color-text-muted);">Aucune catégorie en cache — lance <a href="/categories">Catégories → Synchroniser</a> pour peupler la liste.</span>
                    <?php else: ?>
                        <br><span style="color:var(--color-text-muted);">La liste vient du cache local (rafraîchi par <a href="/categories">Catégories → Synchroniser</a>).</span>
                    <?php endif; ?>
                </span>
